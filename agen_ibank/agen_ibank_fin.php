...
$tran_type = [
    ...
    'Virtual Account Transfer' => 'Virtual Account Transfer',
    'Top Up' => 'Top Up',
...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($channelcode == 'IBA') {
            $query_where .= " AND CHANNELCODE = 'IBA'";
        }

        include 'agen_ibank_fin_conf.php';
