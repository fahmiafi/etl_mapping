...
<div class="content">
    ...
    <div class="container">
        ...
        $limit = $_POST['limit'];
        $id_data = [];
        // echo "SELECT id FROM $tabel WHERE CHANNELCODE = '$channelcode' AND TransactionCategory = '".$_POST['tran_type']."' AND $query_where ".$_POST['where']." LIMIT $limit";
        $sql = mysqli_query($con, "SELECT ID FROM $tabel WHERE CHANNELCODE = '$channelcode' AND TransactionCategory = '".$_POST['tran_type']."' AND $query_where ".$_POST['where']." LIMIT $limit");
